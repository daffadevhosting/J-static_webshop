...
function angkaToRp(angka) {
    if (typeof angka === 'undefined' || angka === null) return 'Rp0';
    var number = Math.round(parseFloat(angka));
...
var cart_kosong = '<div class="empty-cart" style="text-align: center; padding: 60px 20px; color: #666;"><ion-icon name="cart-outline" style="font-size: 80px; color: #ccc; margin-bottom: 16px;"></ion-icon><h3 style="margin-top: 0; color: #333;">Keranjang Kosong</h3><p style="margin-bottom: 0;">Yuk tambahkan produk favoritmu!</p></div><div class="cartUcihaItachi"></div>';
var tombolMinus = '<ion-icon name="remove-circle-outline"></ion-icon>';
var tombolPlus = '<ion-icon name="add-circle-outline"></ion-icon>';
        ...
        generateSimpleCart = function (space) {
            ...
            cartColumnViews = {
                ...
                currency: function (item, column) {
                    return ["<span class='sub-total'>Satuan</span> " + simpleCart.toCurrency(item.get(column.attr) || 0)];
                },
